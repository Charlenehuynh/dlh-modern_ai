...
evaluation_metrics_for_regression = __import__(
    "1-regression_evaluation_metrics"
).evaluation_metrics_for_regression
...
mse_lasso, rmse_lasso, mae_lasso, r2_lasso = evaluation_metrics_for_regression(
    y_test, y_pred_lasso
)
...
plt.scatter(
    y_test, y_pred_lr, alpha=1, c="red", label=f"Linear Regression (R²={r2_lr:.3f})"
)
plt.scatter(
    y_test,
    y_pred_lasso,
