...
model_no_dropout = build_model_with_dropout(
    input_dim, hidden_units, n_layers, dropout_rate_input=0, dropout_rate_hidden=0
)
...
plt.fill_between(
    epochs_range, train_acc_no_dropout, val_acc_no_dropout, color="gray", alpha=0.2
)
...
plt.fill_between(
    epochs_range, train_acc_dropout, val_acc_dropout, color="gray", alpha=0.2
)
